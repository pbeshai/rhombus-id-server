...
/**
 * Taken from http://allstarnix.blogspot.ca/2013/03/how-to-execute-sql-script-file-using.html
 * Removed dependency on apache commons and fixed bug when script had no result set.
 */
